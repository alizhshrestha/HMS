...
(
    ...
    remember_token character varying(256) NOT NULL,
    created_at date NOT NULL,
    updated_at date,
...
(
    ...
    is_invitation character varying(100) NOT NULL,
    invited_by_id character varying(100) NOT NULL,
    is_active boolean NOT NULL,
    activated_date date NOT NULL,
    activated_reason character varying(256),
    created_at date NOT NULL,
    updated_at date,
    CONSTRAINT account_admins_pkey PRIMARY KEY (id),
    CONSTRAINT user_id_accounts_admins_fkey FOREIGN KEY (user_id)
...
(
    ...
    otp_for character varying(80) NOT NULL,
    otp_service_type character varying(50) NOT NULL,
    verified_date date,
    created_at date NOT NULL,
    updated_at date,
