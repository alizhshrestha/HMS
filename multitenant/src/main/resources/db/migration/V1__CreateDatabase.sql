...
ALTER TABLE account_admins
    ADD CONSTRAINT FK_ACCOUNT_ADMINS_ON_ACCOUNT FOREIGN KEY (account_id) REFERENCES accounts (id);

ALTER TABLE account_admins
    ADD CONSTRAINT FK_ACCOUNT_ADMINS_ON_ADMIN FOREIGN KEY (admin_id) REFERENCES admins (id);
